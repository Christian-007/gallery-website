    <div id="home" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="images/img1.jpg" alt="Landscape 1">
                <div class="carousel-caption">
                    
                </div>
            </div>
            <div class="item">
                <img src="images/img2.jpg" alt="Landscape 2">
                <div class="carousel-caption">
                    
                </div>
            </div>
            <div class="item">
                <img src="images/img3.jpg" alt="Landscape 2">
                <div class="carousel-caption">
                    
                </div>
            </div>
            <div class="item">
                <img src="images/img4.jpg" alt="Landscape 2">
                <div class="carousel-caption">
            ...
            <div class="text-center">
                ...
                <div id="panel-landscape" class="thumbnails active">
                    <div class="row images">
                        <div class="col-md-6" ng-repeat="image in images | filter:{category:'landscape'}">
                ...
                <div id="panel-culture" class="thumbnails">
                    <div class="row images">
                        <div class="col-md-6" ng-repeat="image in images | filter:{category:'culture'}">
                            <a class="img-click" href="" data-toggle="modal" data-target="#imgMod">
                                <img ng-src="images/{{image.img_name}}" class="img-responsive" />
                            </a>
                            <div class="caption">
    ...
    <div class="modal fade" id="imgMod" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="divs">
            <div class="cells">
                <img src="" class="img-responsive" alt="Image 1"/>
            </div>
        </div>
